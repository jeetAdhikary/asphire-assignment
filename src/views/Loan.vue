<template>
  <div class="bg-darkBlue md:bg-white h-screen w-full py-3 md:px-10">
    <router-link to="/" class="flex justify-end md:hidden">
      <img class="h-5 object-cover" src="/src/assets/asphire-logo.png" alt="" />
    </router-link>
    <div class="flex items-center space-x-2 p-2 mt-5 mb-3">
      <div class="p-1 rounded bg-lightGreen">
        <CashIcon class="h-5 w-5 text-white" />
      </div>
      <h1 class="text-white md:text-gray-700 font-medium text-lg md:text-xl">
        Loan
      </h1>
    </div>
    <div
    ...
    >
      ...
      <div
        class="md:w-1/2 mt-4 md:mt-0 bg-white rounded-t-lg md:rounded-t-none"
      >
                  ...
                  >
                    ...
                    <div class="flex justify-between w-full">
                      ...
                      <div class="flex items-center space-x-2">
                        <span class="font-semibold text-lightGreen text-base">
                          ${{ item.amount }}
                        </span>
                        <span>
  ...
  >
    <div class="text-center">
      <p class="leading-relaxed my-3">Please conform Repayment for The Loan</p>
